      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-laptop"></i><a href="<?=base_url()?>sqadmin/index/all_frname">All name's friends</a></li>                
...
<div id="container">
    ...
    <h1>add size possition name</h1>
				<form  enctype="multipart/form-data" action="<?=base_url()?>sqadmin/friends" method="post">
       ...
       <div class="form-group">
						...
						<div class="col-sm-5">
							<select name="na" class="form-control" data-validate="required" data-message-required="value_required')">
                              <?php 
										//$parents = $this->db->get('squizes')->result_array();
						...
						<div class="col-sm-5">
							<select name="num" class="form-control" data-validate="required" data-message-required="value_required')">
                                    		...
                                    		<option value="1">1 : primary  friend</option>
                                                ...
                                                <option value="11">11 :  friends</option>
