...
<div id="container">
		...
		<h1>ADD quizz</h1>
						...
						<?= form_open_multipart('sqadmin/create_quiz', ['class'=>'form-horizontal']) ?>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="titre" placeholder="" value="<?=set_value('nom')?>">
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="description" placeholder="" value="<?=set_value('prenom')?>">
			</div>
		  </div>
		  

			  <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">Image index</label>
						<div class="col-sm-10">
						  <input type="file" class="form-control" name="file" >
						</div>
					  </div>
		 <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">Image test </label>
						<div class="col-sm-10">
						  <input type="file" class="form-control" name="file6" >
						</div>
						</div>
						 <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">Image result</label>
						<div class="col-sm-10">
...
<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label">Type</label>
                        
						<div class="col-sm-5">
							<select name="type" class="form-control" data-validate="required" data-message-required="value_required')">
...
<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="typen" class="form-control" data-validate="required" data-message-required="value_required')">
                              <option value="">select</option>
                              <?php 
										$parents = $this->db->get('name')->result_array();
										foreach($parents as $row):
											?>
                                    		<option value="<?php echo $row['id_name'];?>">
