	...
	<body>
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<?= form_open_multipart('sqadmin/update_conf1/' . $id, ['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="description" placeholder="" value="<?= $description ?>">
						</div>
					  </div>
					  
					  <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">keywords seo</label>
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="seo" placeholder="" value="<?= $seo ?>">
						</div>
					  </div>
					  
					  <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">favicon</label>
						<div class="col-sm-10">
