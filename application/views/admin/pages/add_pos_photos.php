      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-laptop"></i><a href="<?=base_url()?>sqadmin/index/all_pos_photos">All types images</a></li>                
          </ol>
        </div>
      </div>
...
<div id="container">
    ...
    <h1>Add size possition image</h1>
				<form  enctype="multipart/form-data" action="<?=base_url()?>sqadmin/index/ajouter_type" method="post">
