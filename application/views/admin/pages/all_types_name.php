    ...
    $tous = $this->model_user->get_all_name();
         ...
         <?php foreach($tous->result() as $user) : ?>
           ...
           <td><?php
              ...
              ?></td>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/delete_name/<?=$user->idname?>" class="btn btn-danger btn-sm" onclick="return confirm('Vous Voulez vraimment supprimer?')">Delete</a>
                </td>
            </tr>
                        <?php endforeach; ?>
