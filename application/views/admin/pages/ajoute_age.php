      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-laptop"></i><a href="<?=base_url()?>sqadmin/index/all_type_age">All types age</a></li>                
          </ol>
        </div>
      </div>
...
<div id="container">
    ...
    <h1>Add size possition Age</h1>
				<form  enctype="multipart/form-data" action="<?=base_url()?>sqadmin/index/add_age" method="post">
