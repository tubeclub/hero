    ...
    $tous = $this->model_user->get_all_types();
         ...
         <?php foreach($tous->result() as $user) : ?>
           ...
           <td><?php
              ...
              ?></td>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/delete_age/<?=$user->idage?>" class="btn btn-danger btn-sm" onclick="return confirm('Vous Voulez vraimment supprimer?')">Delete</a>
                </td>
            </tr>
                        <?php endforeach; ?>
