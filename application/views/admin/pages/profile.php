      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="<?=base_url()?>sqadmin">Home</a></li>
        ...
        <tbody>
         <?php foreach($pro->result() as $user) : ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/update_profile/<?=$user->id?>" class="btn btn-primary btn-sm">modifier</a>
