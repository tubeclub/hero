    ...
    $tous = $this->model_user->get_all_frphotos();
    $tou = $this->model_user->get_all_frphoto();
    $to = $this->model_user->get_all_frphot();
         ...
         <?php foreach($tous->result() as $user) : ?>
           ...
           <td><?php
              ...
              ?></td>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/delete_frphotos/<?=$user->id?>" class="btn btn-danger btn-sm" onclick="return confirm('Vous Voulez vraimment supprimer?')">Delete</a>
                </td>
            </tr>
                        <?php endforeach; ?>
         ...
         <?php foreach($tou->result() as $user) : ?>
           ...
           <td><?php
              ...
              ?></td>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/delete_frphoto/<?=$user->id?>" class="btn btn-danger btn-sm" onclick="return confirm('Vous Voulez vraimment supprimer?')">Delete</a>
                </td>
            </tr>
                        <?php endforeach; ?>
         ...
         <?php foreach($to->result() as $user) : ?>
           ...
           <td><?php
              ...
              ?></td>
                ...
                <td>
                    <a href="<?php echo base_url()?>sqadmin/delete_frphot/<?=$user->id?>" class="btn btn-danger btn-sm" onclick="return confirm('Vous Voulez vraimment supprimer?')">Delete</a>
                </td>
            </tr>
                        <?php endforeach; ?>
