        ...
        this.Create = function (iteration, method) {
            ...
            var scrollerContent;
						...
						switch(childType) {
							...
							scrollerContent = obj.find('> div');
							scrollerChildren = obj.find('> div:first > div');
							break;
						...
						switch (opts.scrollerAlignment.toLowerCase()) {
							...
							$(scrollerChildren).each (function(i) {					
								scrollContentLength += $(this, obj)[0].offsetHeight + parseInt($(this, obj).css('marginTop')) + parseInt($(this, obj).css('marginBottom'));
							...
							default:
							$(scrollerChildren).each (function(i) {					
								scrollContentLength += $(this, obj)[0].offsetWidth + parseInt($(this, obj).css('marginLeft')) + parseInt($(this, obj).css('marginRight'));
