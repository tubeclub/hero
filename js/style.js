...
{LangMenu_show=false;$('.topbarre_lang_select').removeClass('topbarre_lang_select_select');$('.topbarre_lang_list').slideUp(250);$('.topbarre_lang_select_arrow').attr('src','http://speedquiizz.com/assets/images/icon-lang-arrow.png');}}
